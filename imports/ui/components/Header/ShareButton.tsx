...
export const ShareButton: React.FC<ShareButtonProps> = ({ session }) => {
  ...
  const handleInvite = () => {
    ...
    Meteor.call(
      'sessions.inviteByEmail',
      session._id,
      inviteEmail.trim(),
      (err: MeteorError | null, result?: SessionInviteResult) => {
  ...
  return (
    <>
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title="Share Session" size="md">
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              If they have an account, they'll be added instantly. Otherwise, they'll get an invite
              link.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white"
                />
                <Button variant="secondary" onClick={() => copyToClipboard(tokenUrl)}>
                  Copy
                </Button>
              </div>
              <p className="text-xs text-gray-500 mt-1">
