      ...
      <main className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Collaborate on code reviews in real-time. See cursors, discuss changes, and ship better
            code together.
          </p>
        ...
        <div className="mt-32 grid md:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
            ...
            <p className="text-gray-400">
              See exactly where your teammates are looking in real-time. Follow along as they
              explain code.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
            ...
            <p className="text-gray-400">
              Leave inline comments on any line. Discuss, resolve, and track changes through the
              review process.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
            ...
            <p className="text-gray-400">
              Import pull requests directly from GitHub. Review diffs and collaborate without
